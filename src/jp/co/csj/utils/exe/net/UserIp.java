...
public class UserIp {
	...
	public static void main(String[] args) throws Throwable {
		System.out.println("本机的外网IP是："
				+ UserIp.getWebIP("http://iframe.ip138.com/ic.asp"));
		System.out.println("本机的内网IP是：" + UserIp.getLocalIP());
	}

	public static String getWebIp() {
		String ret  = UserIp.getWebIP("http://www.ip138.com/ip2city.asp");
		
		if (CmnStrUtils.isNotEmpty(ret)) {
			return ret;
		} else {
			return "analize error";
		}
	}
	/**
	 * 获取外网地址
